...
// ::GConverterInputStream* g_converter_input_stream_new (::GInputStream* base_stream, ::GConverter* converter);
...
void ConverterInputStreamClassDef::class_init (gpointer class_struct, gpointer )
{
