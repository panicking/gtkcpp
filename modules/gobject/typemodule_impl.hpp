...
{
  typedef void (*call_wrap_t) (::GTypeModule* module, GType instance_type, GType interface_type, const ::GInterfaceInfo* interface_info);
...
{
  typedef GType (*call_wrap_t) (::GTypeModule* module, const char* name, const ::GEnumValue* const_static_values);
...
{
  typedef GType (*call_wrap_t) (::GTypeModule* module, const char* name, const ::GFlagsValue* const_static_values);
...
{
  typedef GType (*call_wrap_t) (::GTypeModule* module, GType parent_type, const char* type_name, const ::GTypeInfo* type_info, ::GTypeFlags flags);
...
{
  typedef void (*call_wrap_t) (::GTypeModule* module, const char* name);
...
{
  typedef void (*call_wrap_t) (::GTypeModule* module);
...
{
  typedef gboolean (*call_wrap_t) (::GTypeModule* module);
