...
{
  static GParamSpec *new_(const std::string &name, const std::string &nick,
      const std::string &blurb, T min, T max, T _default,
  ...
  static GParamSpec *new_(const std::string &name, const std::string &nick,
      const std::string &blurb, T min, T max,
      ParamFlags flags = (ParamFlags)G_PARAM_READWRITE)
  {
...
{
  static GParamSpec *new_(const std::string &name, const std::string &nick,
      const std::string &blurb, bool _default,
      ParamFlags flags = (ParamFlags)G_PARAM_READWRITE)
  {
...
{
  static GParamSpec *new_(const std::string &name, const std::string &nick,
      const std::string &blurb, const std::string &_default,
      ParamFlags flags = (ParamFlags)G_PARAM_READWRITE)
  {
...
{
  static GParamSpec *new_(const std::string &name, const std::string &nick,
      const std::string &blurb, guint _default = 0,
      ParamFlags flags = (ParamFlags)G_PARAM_READWRITE)
  {
...
public:
  ...
  static ParamSpec new_(const std::string &name, ParamSpec overridden)
  {
    return static_cast<ParamSpec &&>(
        super(g_param_spec_override(name.c_str(), overridden.gobj_())));
  }

  std::string get_blurb() { return g_param_spec_get_blurb(gobj_()); }

  std::string get_nick() { return g_param_spec_get_nick(gobj_()); }

  std::string get_name() { return g_param_spec_get_name(gobj_()); }
